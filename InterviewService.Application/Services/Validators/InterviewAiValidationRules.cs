...
{
    public static bool IsValidFormElement(FormElement? formElement)
    {
    ...
    public static bool IsValidQuestion(Question? question)
    {
        if (question is null || string.IsNullOrWhiteSpace(question.QuestionText))
        {
            return false;
        }
    ...
    public static bool IsValidUserProfile(UserProfile? userProfile)
    {
